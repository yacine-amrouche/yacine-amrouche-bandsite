...
document.querySelector("#submit-btn").addEventListener("click", async (e) => {
  ...
  const myNewComment = { name: newName.value, comment: newComment.value };
...
backend.deleteComment("19ba345a-b1da-406c-b638-d63de781a107");
backend.deleteComment("5aa4ab80-1d22-44f0-a565-ee1e73c5b10e");
